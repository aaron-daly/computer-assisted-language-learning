...
angular.module('calliApp')
    ...
    .factory('scenarioGame', ['$http', 'scenario',
        function($http, scenario){
            ...
            //How scenarios are seen throughout the program
            var scenarioGame = {
                scenario: {},
                scenarioList: [],
                position: 1,
            ...
            scenarioGame.tick = function(answer, callback) {
                ...
                if(scenarioGame.scenario.conversation[scenarioGame.position -1].translation) {
                    ...
                    //filing array with translations
                    scenarioGame.recordedTranslations.push(translationAnswers);
                }
                //if the scenario type is not conversation fill array with correct boolean values
